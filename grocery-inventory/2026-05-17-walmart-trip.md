# 2026-05-17 Walmart Trip

Purpose: establish a weekly baseline after the initial pantry/freezer inventory.

## Pre-Trip Situation

- Pantry and freezer are heavy on dry goods, frozen meals, frozen vegetables, beans, pasta, oatmeal, ramen, and snacks.
- Fridge is heavy on condiments, dressings, sauces, jars, cheese, and leftovers.
- Fresh fruit, bread/tortillas, baby-safe snacks, and lunch proteins appear to be the better gaps.
- The shopping trip should avoid doubling up on freezer meals unless there is a specific family favorite.
- The shopping trip should also avoid more condiments or cheese unless tied to a specific meal.

## Target Cart

- Fresh dairy: milk/eggs only if low after checking counts, yogurt if useful for baby/kids.
- Fresh produce: bananas, apples, berries/soft fruit, avocados, greens, cucumbers, potatoes/sweet potatoes, onion, garlic.
- Lunch staples: bread, tortillas, deli meat, sliced cheese.
- Easy protein: rotisserie chicken plus one raw protein if needed.
- Baby-safe snacks: soft fruit, applesauce/yogurt pouches, dissolvable toddler snacks, low-sodium beans, eggs.
- Assembly helpers: salsa, pasta sauce, taco items, salad/slaw.

## Cart Photos

Save photos here: `grocery-inventory/cart-photos/`
...
Save photos here: `grocery-inventory/receipts/`
